...
namespace gc
{
	class GIFCapture : public ed::IPlugin1
	{
	public:
		...
		virtual bool HasCustomMenuItem();
	...
	private:
		...
		uint8_t* m_frame, *m_frameFlipped;

		char m_outputPath[512];
		bool m_useLogo;

		bool m_showProperties;
		std::string m_tempProp;
		void m_renderProperties();
		...
		float m_waitMS;
		float m_lastFrameCapture;
		float m_timeCaptureStarted;
		int m_frameIndex;
	};
}